...
LocalStorageManager.prototype.getSkin = function () {
  return this.storage.getItem(this.skinKey) || 'sk2048';
};

LocalStorageManager.prototype.setSkin = function (skin) {
  this.storage.setItem(this.skinKey, skin);
};
